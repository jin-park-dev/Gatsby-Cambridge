const portfolioItems = [
  ...
  {
    title: 'PWA Pomodoro',
    synopsis: 'Open source installable pomodoro app (PWA) built with ClojureScript',
    desc: 'PWA-Pomodoro is progressive web app installable on Android, iOS, Desktop. Built with ClojureScript, Reagent, Re-frame, Google Workbox, Tailwind CSS.',
    img: './portfolio/pwa-pomodoro-pomo-iphone.png',
    links: [
      { "url": "https://pomo.kanxdoro.com/", "content": "Link to PWA-Pomodoro" },
      { "url": "https://gitlab.jinis.online/jin/pomotimer-plusplus", "content": "Link to Gitlab" },
    ],
    idx: 6
  },
]
